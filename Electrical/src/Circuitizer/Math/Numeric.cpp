...
namespace math
{
	...
	Numeric::operator int()		{ return (int)magnitude(*this); }
	Numeric::operator float()	{ return (float)magnitude(*this); }
	Numeric::operator double()	{ return (double)magnitude(*this); }
	...
	Numeric Numeric::operator*(Numeric& n)		{ return Numeric((m_real * real(n)) - (m_imaginary * imaginary(n)), (m_real * imaginary(n)) + (m_imaginary * real(n))); }
	Numeric& Numeric::operator*=(Numeric& n)	{ Set(*this * n); return *this;}
	Numeric Numeric::operator+(Numeric& n)		{ return Numeric(m_real + n.m_real, m_imaginary + n.m_imaginary); }
